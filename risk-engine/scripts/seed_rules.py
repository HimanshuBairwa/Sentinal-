...
# DSN order: DATABASE_URL env (set by compose) → sensible local default.
    ...
    try:
        for r in RULES:
            ...
            if exists:
                ...
                """, str(uuid4()), r["rule_id"], r["name"], r.get("description", f"Detects: {r['name'].lower()}"), r["expression"], r["score_contribution"], r["action"], True, 50)
